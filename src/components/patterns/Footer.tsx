export function Footer(props) {
  return (
    <footer className="w-full h-20 hstack gap-8 py-3 px-4 justify-around fixed left-0 right-0 bottom-0 z-10 bg-gradient-to-b rounded-t-3xl from-[#2c3657] to-[#141d33]">
